...
class YOLOOBBConverter:
    def __init__(
        self,
        file_path = r"E:\high_work\transfer_video\chaichu_8_7_label\project-14-at-2024-08-07-08-10-c4364c22.csv",
        target_path = r"E:\high_work\transfer_video\chaichu_8_7_label", #destination folder
